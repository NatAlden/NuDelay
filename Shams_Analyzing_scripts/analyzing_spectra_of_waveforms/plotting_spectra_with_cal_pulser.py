...
JSON_FILE       = Path("atten_50_no_HighPass_trig_mode_0.json")
...
plt.title("Deep-chain averaged channels + cal-pulser  •  frequency domain")
plt.xlim(FREQ_MIN_GHZ, FREQ_MAX_GHZ)
plt.ylim(0, 1.2 )  # Adjust y-limits to fit all curves
plt.grid(True, lw=0.3, alpha=0.7)
plt.legend(ncol=3, fontsize=8)
plt.tight_layout()
plt.savefig("combined_frequency_domain_not_windowed.png", dpi=300)
plt.show()
