...
# Load the data
with open("trigger_efficiency_mode_1_no_filters.json", "r") as f:
    data = json.load(f)
...
ax.set_title("Trigger Efficiency Curve with Sigmoid Fit")
ax.grid(True)
ax.set_xlim(1, 6)
ax.set_ylim(0, 1.1)
plt.tight_layout()
plt.savefig("trigger_efficiency_curve_detailed_predicted_SNR_sigmoid_mode1.png", dpi=300)