...
# === Parameters ===
in_angles = np.arange(-50, 51, 10)  # degrees
attenuation_codes = np.arange(20, 128, 4)  # DAC values for attenuation (0–127)
calibration_delays = [5.08, 0, 5.08, 6.14]  # per-channel fixed delay offsets (ns)
