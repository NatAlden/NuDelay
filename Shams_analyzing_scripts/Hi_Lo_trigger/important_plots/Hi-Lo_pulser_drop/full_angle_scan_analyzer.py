...
# Constants
SNR_slope =0.2398253642103035  # Slope for SNR calculation
...
plt.title("SNR at 50% Efficiency vs Angle - Hi_Lo Trigger - Pulser_drop 30_150")
...
plt.grid(True)
plt.tight_layout()
plt.savefig("fine_scan_all_angles_pulser_drop_2_filters.png", dpi=300)
"""
"""
output_data = {
